...
@section('content')
    {{-- table --}}
        <x-admin.table addbutton="{{route('admin.introhowworks.create')}}" deletebutton="{{route('admin.introhowworks.deleteAll')}}">
                ...
                @foreach($rows as $row)
                    <tr class="delete_row">
                        ...
                        <td class="product-action">
                            <span class="action-edit text-primary"><a href="{{route('admin.introhowworks.edit' , ['id' => $row->id])}}"><i class="feather icon-edit"></i></a></span>
                            <span class="delete-row text-danger" data-url="{{url('admin/introhowworks/'.$row->id)}}"><i class="feather icon-trash"></i></span>
                        </td>
                    </tr>
                @endforeach
            </x-slot>
