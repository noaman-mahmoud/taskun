...
@section('content')
    <x-admin.table filter="true"  deletebutton="{{route('admin.bankTransfers.deleteAll')}}">
                    ...
                    <tr class="delete_row">
                        ...
                        <td>
                            <a href="{{$row->image}}" target="_blank">
                                <img src="{{$row->image}}" width="50px" height="50px" alt="">
                            </a>
                        </td>
                        <td>{{$row->name}}</td>
...
{{--                            <span class="action-edit text-primary"><a href="{{route('admin.bankTransfers.edit' , ['id' => $row->id])}}"><i class="feather icon-edit"></i></a></span>--}}
                            <span class="delete-row text-danger" data-url="{{url('admin/bank-transfers/'.$row->id)}}"><i class="feather icon-trash"></i></span>
                        </td>
                    </tr>
                @endforeach
            </x-slot>
