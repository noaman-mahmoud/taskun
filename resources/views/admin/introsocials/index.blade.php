...
@section('content')
    {{-- table --}}
        <x-admin.table  addbutton="{{route('admin.introsocials.create')}}" deletebutton="{{route('admin.introsocials.deleteAll')}}">
                ...
                @foreach($rows as $row)
                    <tr class="delete_row">
                        ...
                        <td class="product-action">
                            <span class="action-edit text-primary"><a href="{{route('admin.introsocials.edit' , ['id' => $row->id])}}"><i class="feather icon-edit"></i></a></span>
                            <span class="delete-row text-danger" data-url="{{url('admin/introsocials/'.$row->id)}}"><i class="feather icon-trash"></i></span>
                        </td>
                    </tr>
                @endforeach
            </x-slot>
