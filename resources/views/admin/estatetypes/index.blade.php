...
@section('content')
    <x-admin.table filter="true" addbutton="{{route('admin.estatetypes.create')}}" deletebutton="{{route('admin.estatetypes.deleteAll')}}">
            <x-slot name="tableHead">
                ...
                <th>{{awtTrans('الاسم بالغه الانجلزيه')}}</th>
                ...
                @foreach($rows as $row)
                    <tr class="delete_row">
                        ...
                        <td class="product-action">
                            <span class="action-edit text-primary"><a href="{{route('admin.estatetypes.edit' , ['id' => $row->id])}}"><i class="feather icon-edit"></i></a></span>
                            <span class="delete-row text-danger" data-url="{{url('admin/estatetypes/'.$row->id)}}"><i class="feather icon-trash"></i></span>
                        </td>
                    </tr>
                @endforeach
            </x-slot>
