                ...
                @foreach($rows as $row)
                    <tr class="delete_row">
                        ...
                        <td class="product-action">
                            <span class="action-edit text-primary"><a href="{{route('admin.admins.edit' , ['id' => $row->id])}}"><i class="feather icon-edit"></i></a></span>
                            @if ($row->id != 1 && auth()->id() != $row->id )
                                <span class="delete-row text-danger" data-url="{{url('admin/admins/'.$row->id)}}"><i class="feather icon-trash"></i></span>
                            @endif
                        </td>
                    </tr>
                @endforeach
