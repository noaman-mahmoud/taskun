...
@section('content')
    <x-admin.table filter="true" addbutton="{{route('admin.copys.create')}}" deletebutton="{{route('admin.copys.deleteAll')}}">
                ...
                @foreach($rows as $row)
                    <tr class="delete_row">
                        ...
                        <td class="product-action">
                            <span class="action-edit text-primary"><a href="{{route('admin.copys.edit' , ['id' => $row->id])}}"><i class="feather icon-edit"></i></a></span>
                            <span class="delete-row text-danger" data-url="{{url('admin/copys/'.$row->id)}}"><i class="feather icon-trash"></i></span>
                        </td>
                    </tr>
                @endforeach
            </x-slot>
