                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <input type="email" name="email" value="{{$row->email}}" class="form-control" placeholder="{{awtTrans('اكتب البريد الالكتروني')}}"  >
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-12">
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            <label for="first-name-column">{{awtTrans('السجل التجاري')}}</label>
                                            <div class="controls">
                                                <input type="text" name="commercial" value="{{$row->commercial}}" class="form-control" placeholder="{{awtTrans('سجل التجاري')}}"  >
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            <label for="first-name-column">{{awtTrans('رقم المعلن العقاري')}}</label>
                                            <div class="controls">
                                                <input type="text" name="advertiser_number" value="{{$row->advertiser_number}}" class="form-control" placeholder="{{awtTrans('رقم المعلن العقاري')}}"  >
                                            </div>
                                        </div>
                                    </div>
                                    @endif
