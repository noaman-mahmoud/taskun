                ...
                @foreach($rows as $row)
                    <tr class="delete_row">
                        ...
                        <td class="product-action">
                            <span class="action-edit text-primary"><a href="{{route('admin.intromessages.show' , ['id' => $row->id])}}"><i class="feather icon-eye"></i></a></span>
                            <span class="delete-row text-danger" data-url="{{url('admin/intromessages/'.$row->id)}}"><i class="feather icon-trash"></i></span>
                        </td>
                    </tr>
                @endforeach
            </x-slot>
