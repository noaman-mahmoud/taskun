...
@section('content')
    <x-admin.table filter="true" addbutton="{{route('admin.offers.create')}}" deletebutton="{{route('admin.offers.deleteAll')}}">
...
{{--                        <td>{{$row->name}}</td>--}}
                        ...
                        <td class="product-action">
                            <span class="action-edit text-primary"><a href="{{route('admin.offers.edit' , ['id' => $row->id])}}"><i class="feather icon-edit"></i></a></span>
                            <span class="delete-row text-danger" data-url="{{url('admin/offers/'.$row->id)}}"><i class="feather icon-trash"></i></span>
                        </td>
                    </tr>
                @endforeach
            </x-slot>
