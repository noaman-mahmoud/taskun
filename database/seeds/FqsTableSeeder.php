...
class FqsTableSeeder extends Seeder
{
    ...
    {
        DB::table('fqs')->insert([
            'question'       => json_encode(['ar' => 'تقديم تجربة ذات طابع شخصي لك:', 'en' => 'Providing you with a personalized experience:' ]) ,
        ...
        DB::table('fqs')->insert([
            'question'       => json_encode(['ar' => 'توفير إمكانية التواصل مع الأشخاص والمؤسسات التي تهتم بها', 'en' => 'Providing the ability to communicate with the people and organizations you are interested in' ]) ,
        ...
        DB::table('fqs')->insert([
            'question'       => json_encode(['ar' => 'تشجيعك على التعبير عن نفسك والتواصل بشأن ما يهمّك:', 'en' => 'Encouraging you to express yourself and communicate what matters to you:' ]) ,
        ...
        DB::table('fqs')->insert([
            'question'       => json_encode(['ar' => 'مساعدتك في اكتشاف المحتوى والمنتجات والخدمات التي قد تهتم بها:', 'en' => 'Helping you discover content, products and services you may be interested in:' ]) ,
        ...
        DB::table('fqs')->insert([
            'question'       => json_encode(['ar' => 'مواجهة السلوكيات الضارة وحماية ودعم مجتمعنا:', 'en' => 'Confront harmful behavior and protect and support our community:' ]) ,
        ...
        // DB::table('fqs')->insert([
        //     'question'       => json_encode(['ar' => '', 'en' => '' ]) ,
        //     'answer'       => json_encode(['ar' => '', 'en' => '' ]) ,
        // ]);
    }
}
